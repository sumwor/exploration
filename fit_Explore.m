function [qpar, negloglike, bic, nlike, hess]=fit_Explore(stats,fit_fun,initpar,x,lb,ub)    
% % fit_fun %
...
if ~exist('lb','var')
    ...
    [qpar,negloglike,exitflag,out,grad,hess]=fminunc(func_handle, initpar, op, [c V RU V_TU]);
else
