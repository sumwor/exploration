function stats=algo_UCB(stats,params,x)

% % algo_UCB %
%PURPOSE:   Simulate player based on Upper Confidence Bound
...
stats.pl(stats.currTrial,x)=normcdf(((stats.ql(stats.currTrial,x)-stats.qr(stats.currTrial,x))+params.gamma*(stats.sigmaL(stats.currTrial,x)-stats.sigmaR(stats.currTrial,x)))/params.lambda);
